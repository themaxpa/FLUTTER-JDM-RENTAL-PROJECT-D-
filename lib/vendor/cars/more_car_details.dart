                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildSpecificationItem(
                            'Maximum Power',
                            '${widget.car['power'] ?? '1015'} CV',
                            CupertinoIcons.gauge,
                          ),
                          _buildSpecificationItem(
                            'Top Speed',
                            '>${widget.car['maxSpeed'] ?? '350'} Km/H',
                            CupertinoIcons.speedometer,
                          ),
                          _buildSpecificationItem(
                            'Consumption',
                            '${widget.car['consumption'] ?? '11.86'} L/100km',
                            CupertinoIcons.gauge,
                          ),
                          _buildSpecificationItem(
                            'Acceleration\n0-100 Km/H',
                            '${widget.car['Speed (0-100)'] ?? '2.5'} sec',
                            CupertinoIcons.timer,
                          ),
                          _buildSpecificationItem(
                            'Body Type',
                            widget.car['carType'] ?? 'Coupe',
                            CupertinoIcons.car_detailed,
                          ),
                          _buildSpecificationItem(
                            'Year',
                            widget.car['year'] ?? '2024',
