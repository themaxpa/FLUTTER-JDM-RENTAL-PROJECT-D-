...
class _UsersCardScreenState extends State<UsersCardScreen> {
  ...
  bool isLoading = true; // Loading state for checking admin
  ...
  void checkAdmin() async {
    ...
    setState(() {
      isAdminUser = admin;
      isLoading = false; // Set loading to false once the admin check is done
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: isLoading
          ? Center(
              child:
                  CircularProgressIndicator()) // Show loading until admin check completes
          : isAdminUser
              ? StreamBuilder(
